...
```{r KM curve os,echo=FALSE,fig.width=3.5, fig.height=1.8,warning=FALSE}
...
coxph(Surv(time=os_time,event=os_status) ~ patient_grouping+figo_staging+performance_status+brca_status+CRM+distance_anal_verge_final+histological_grade_baseline+time_interval_RT_surgery,
