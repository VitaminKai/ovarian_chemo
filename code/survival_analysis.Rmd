...
coxph(Surv(time=os_time,event=os_status) ~ patient_grouping+age_at_diagnosis+figo_staging+performance_status+brca_status+
        surgical_outcome+time_interval_RT_surgery,
